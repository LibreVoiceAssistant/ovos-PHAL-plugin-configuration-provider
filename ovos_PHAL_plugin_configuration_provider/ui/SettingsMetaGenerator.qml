...
Mycroft.Delegate {
    ...
    function selectSettingUpdated(key, value) {
        ...
        triggerGuiEvent("ovos.configuration.provider.update.setting", {"configuration": configuration,  "skill_id": settingsMetaGeneratorView.skill_id})
    }
